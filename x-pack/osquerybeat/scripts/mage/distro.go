...
import (
	...
	"github.com/T0kii/beats/v7/x-pack/osquerybeat/internal/fetch"
	"github.com/T0kii/beats/v7/x-pack/osquerybeat/internal/fileutil"
	"github.com/T0kii/beats/v7/x-pack/osquerybeat/internal/hash"
	"github.com/T0kii/beats/v7/x-pack/osquerybeat/internal/tar"
)
