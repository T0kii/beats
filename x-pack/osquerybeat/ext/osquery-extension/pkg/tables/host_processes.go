...
import (
	...
	"github.com/T0kii/beats/v7/x-pack/osquerybeat/ext/osquery-extension/pkg/hostfs"
	"github.com/T0kii/beats/v7/x-pack/osquerybeat/ext/osquery-extension/pkg/proc"
)
