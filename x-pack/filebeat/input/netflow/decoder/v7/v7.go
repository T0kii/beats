...
import (
	...
	"github.com/T0kii/beats/v7/x-pack/filebeat/input/netflow/decoder/config"
	"github.com/T0kii/beats/v7/x-pack/filebeat/input/netflow/decoder/fields"
	"github.com/T0kii/beats/v7/x-pack/filebeat/input/netflow/decoder/protocol"
	"github.com/T0kii/beats/v7/x-pack/filebeat/input/netflow/decoder/record"
	"github.com/T0kii/beats/v7/x-pack/filebeat/input/netflow/decoder/template"
	v1 "github.com/T0kii/beats/v7/x-pack/filebeat/input/netflow/decoder/v1"
)
