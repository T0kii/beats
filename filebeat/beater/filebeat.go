...
import (
	...
	_ "github.com/T0kii/beats/v7/filebeat/include"
	"github.com/T0kii/beats/v7/filebeat/input"
	v2 "github.com/T0kii/beats/v7/filebeat/input/v2"
	"github.com/T0kii/beats/v7/filebeat/input/v2/compat"
	"github.com/T0kii/beats/v7/filebeat/registrar"
	...
	_ "github.com/T0kii/beats/v7/filebeat/processor/add_kubernetes_metadata"
	_ "github.com/T0kii/beats/v7/libbeat/processors/decode_csv_fields"

	// include all filebeat specific autodiscover features
	_ "github.com/T0kii/beats/v7/filebeat/autodiscover"
)
